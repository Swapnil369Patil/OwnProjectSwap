 ...
 */
public class PassangerDobfirst1 {
    static WebDriver driver;
    public static void passangerdob1fun(WebDriver driver,String setDate) throws ParseException {

        SimpleDateFormat myDateFormat=new SimpleDateFormat("dd/MM/yyyy");
        SimpleDateFormat calDateFormat=new SimpleDateFormat("MMMM yyyy");
        java.util.Date date=myDateFormat.parse(setDate);

        driver.findElement(By.xpath(".//*[@id='datetimepickerPsngr_0']/span[2]")).click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);

        /*Date*/ java.util.Date curDate=calDateFormat.parse(driver.findElement(By.xpath(".//*[@id='datetimepickerPsngr_0']/div/ul/li[1]/div/div[1]/table/thead/tr[1]/th[2]")).getText());
        ...
        for (int i=1;i<=monthDiff;i++){
            ...
            driver.findElement(By.xpath(".//*[@id='datetimepickerPsngr_0']/div/ul/li[1]/div/div[1]/table/thead/tr[1]/th[@class="+(isFuture?"'next'":"'prev'")+"]")).click();
        }
