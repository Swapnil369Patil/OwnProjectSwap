 ...
 */
public class EnquiryFromdate {
    static WebDriver driver;
    public static void fromdatefun(WebDriver driver,String setDate) throws ParseException {

        SimpleDateFormat myDateFormat=new SimpleDateFormat("dd/MM/yyyy");
        SimpleDateFormat calDateFormat=new SimpleDateFormat("MMMM yyyy");
        java.util.Date date=myDateFormat.parse(setDate);

        driver.findElement(By.xpath(".//*[@class='input-group-addon']/span")).click();
